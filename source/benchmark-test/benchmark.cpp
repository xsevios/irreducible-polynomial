...
std::vector<Polynom> BenchmarkRunner::generatePolynoms(const int minDim, const int maxDim, const int minDegree, const int maxDegree, const int polyCountForEach)
{
...
void BenchmarkRunner::run(std::vector<Polynom> &polynoms, Benchmark& benchmark)
{
...
std::vector<Benchmark> BenchmarkRunner::runAll(std::vector<Polynom>& polynoms)
{
...
Polynom BenchmarkRunner::GenRandPolynom(const Polynom &p)
{
